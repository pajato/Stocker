...
public class InputCallbackHandlerUnitTest {
    ...
    @Test public void unitTest() {
        ...
        Assert.assertTrue("Test the instance value.", InputCallbackHandler.valueOf("instance") == InputCallbackHandler.instance);

        // Cover the values() method.
        Assert.assertTrue("Test that there is only a single value.", InputCallbackHandler.values().length == 1);
    }
